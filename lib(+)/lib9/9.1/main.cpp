...
int main(int argc, char *argv[])
{
    ...
    // в которой написана программа.// "Windows-1251" - для Windows, "KOI8-R" - Linux и т.д.
    QTextCodec * codec = QTextCodec::codecForName("Windows-1251");
    // Создаем главное окно
    QWidget *hbox = new QWidget();
    hbox->setWindowTitle( RUS("Input age") );
    QSpinBox *spinBox = new QSpinBox( hbox );
    QSlider *slider = new QSlider(Qt::Horizontal, hbox );
    spinBox->setRange(0, 130);
    slider->setRange(0, 130);
    spinBox->setValue(35);
    QPushButton * btn = new QPushButton( RUS("exit"), hbox );
    //***************************************************************************
